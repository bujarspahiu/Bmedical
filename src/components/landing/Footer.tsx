      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid lg:grid-cols-6 md:grid-cols-3 gap-8 mb-12">
          <div className="lg:col-span-2">
            ...
            <p className="text-sm leading-relaxed text-slate-400 max-w-sm">{t.footer.description}</p>
          </div>

          <div>
            <div className="font-semibold text-white mb-4 text-sm">{t.footer.product}</div>
          ...
          <div>
            <div className="font-semibold text-white mb-4 text-sm">{t.footer.company}</div>
            <ul className="space-y-2 text-sm">
          ...
          <div>
            <div className="font-semibold text-white mb-4 text-sm">{t.footer.legal}</div>
            <ul className="space-y-2 text-sm">
